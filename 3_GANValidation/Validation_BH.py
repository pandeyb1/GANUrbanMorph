...
def plot_generator_examples(dataloader, generator, device='cpu', num_examples=5):
    ...
    targets_batch = np.exp((targets_batch.numpy() + 1) * np.log(75)/2)

    outputs_batch = outputs_batch.cpu()
    outputs_batch = np.exp((outputs_batch.numpy() + 1) * np.log(75)/2)
    ...
    plt.tight_layout()
    plt.show()
    return targets_batch, outputs_batch
    ...
    def __init__(self, input_dir, target_dir):
        ...
        for filename in self.input_files:
            ...
            with rasterio.open(input_path) as src:
                input_image = src.read(1).astype(np.float32)
                input_image = (input_image) * 2 - 1
            with rasterio.open(target_path) as src:
                target_image = src.read(1).astype(np.float32) * 0.3048 
                target_image[target_image > 75] = 75
                lgti = np.log(target_image)
                target_image[target_image!=0] = lgti[target_image!=0]
                target_image = (target_image/np.log(75)) * 2 - 1
...
def shanentropy(ref):
    refhist,_ =np.histogram(ref,bins=128,range=(0,75))
...
def runtestinference(modelfile,dataloader,device):
    ...
    inp, target = plot_generator_examples(dataloader, generator, device='cpu', num_examples=4)
    ...
    for i, (input_images,target_images) in enumerate(dataloader):
        ...
        for j in range(imb):
            ...
            pred = np.exp((pred + 1) * np.log(75)/2)
            ref = np.exp((ref + 1) * np.log(75)/2)
            ...
            refsum.append(ref.mean())
            predsum.append(pred.mean())
            outr.append(rval)
    ...
    plt.scatter(np.array(refsum),np.array(predsum),alpha=0.25,c="k")
    plt.ylabel("Generated",fontsize=14)
    plt.xlabel("Real",fontsize=14)
    plt.title("Average Building Height (m)",fontsize=16)
    #plt.axline((0, 0), slope=1,c='k')
    slp, interc, rval,pval,stnderr = scipy.stats.linregress(np.array(refsum),np.array(predsum))
    print(slp,interc,rval,pval)
    add_equation_and_r2(ax, slp, interc, rval, x_pos=0.7, y_pos_eq=0.3, y_pos_r2=0.25, color='k', fontsize=14)
    plt.show()
    ...
    plt.xlabel("Real",fontsize=14)
    #plt.axline((0, 0), slope=1,c='k')
    plt.title("Average Building Height (m) Heterogeneity",fontsize=16)
...
#input_dir = "/Users/9oy/Documents/Projects/IM3/EvaluationP/Data/TrainingData/Archive/BFrac"
#target_dir = "/Users/9oy/Documents/Projects/IM3/EvaluationP/Data/TrainingData/Archive/BHeight"

input_dir = "/Users/9oy/Documents/Projects/IM3/EvaluationP/Data/TestNooverlap/Frac"
target_dir = "/Users/9oy/Documents/Projects/IM3/EvaluationP/Data/TestNooverlap/Target"
...
modelfile1 = "/Users/9oy/Documents/Projects/IM3/EvaluationP/Script/2_EvalP/v1/BH/BFCond_BHgenerator_withLatentVector_100L_epoch_1000_LR_0.0001.pth"
modelfile2 = "/Users/9oy/Documents/Projects/IM3/EvaluationP/Script/2_EvalP/v1/BH/BFCond_BHgenerator_withLatentVector_100L_epoch_1000_LR_0.0002.pth"
modelfile3 = "/Users/9oy/Documents/Projects/IM3/EvaluationP/Script/2_EvalP/v1/BH/BFCond_BHgenerator_withLatentVector_100L_epoch_1000_LR_0.0005.pth"
modelfile4 = "/Users/9oy/Documents/Projects/IM3/EvaluationP/Script/2_EvalP/v1/BH/BFCond_BHgenerator_withLatentVector_100L_epoch_1000_LR_0.001.pth"
modelfile5 = "/Users/9oy/Documents/Projects/IM3/EvaluationP/Script/2_EvalP/v1/BH/BFCond_BHgenerator_withLatentVector_100L_epoch_1000_LR_0.005.pth"
